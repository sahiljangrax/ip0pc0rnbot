 ...
 #   if user_id in ADMINS: return
    ...
    if await db.get_pm_search_status(bot_id):
        ...
        await message.reply_text("<b><i>ɪ ᴀᴍ ɴᴏᴛ ᴡᴏʀᴋɪɴɢ ʜᴇʀᴇ. ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ.</i></b>",
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url=f'https://t.me/+PSf-C28n6tJkNmU1')]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        return await query.message.edit(text=f'<b>ᴛʜᴀɴᴋs ғᴏʀ ᴊᴏɪɴɪɴɢ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ 🔥😗\n<code>ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇ : {files.file_name[:20]}</code>.. ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ⚡\n\nPromote Your Services Here : @LmOwnerBot</b>',reply_markup=reply_markup)
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await query.message.reply_sticker("CAACAgUAAxkBAAEM7DRnATJZOPweB-XB7wnaif-DO1ogOgACzREAAiBkCFS103fRM9Ra7jYE") 
        await m.delete()
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆', url=f'https://t.me/LMOWNERBOT')
        ],[
    ...
    # If the user isn't an admin, return
      ...
      await client.edit_message_media(
       ...
       await client.edit_message_media(
        ...
        await query.answer("Meet the minds behind this bot:@LmOwnerBOT❤️ A big thank you for making this bot awesome!", show_alert=True)
 
    elif query.data == "Source":
        buttons = [[
            InlineKeyboardButton('Aja Munna Lele Repo(Paisa Ho Tabhi Message Kariyo)', url='https://t.me/LMOWNERBOT')
        ],[
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/LMOWNERBOT'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
          message_id=query.message.id,
          media=InputMediaAnimation(
            media="https://i.ibb.co/RYV0mdR/doc-2024-10-05-17-05-49.png",
